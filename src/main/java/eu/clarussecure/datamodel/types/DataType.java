...
public enum DataType {
    ...
    @SerializedName("categoric") CATEGORIC("categoric"),
    @SerializedName("categoric_ordinal") CATEGORIC_ORDINAL("categoric_ordinal"),
    @SerializedName("numeric_discrete") NUMERIC_DISCRETE("numeric_discrete"),
    @SerializedName("numeric_continuous") NUMERIC_CONTINOUS("numeric_continuous"),
    @SerializedName("geometric_object") GEOMETRIC_OBJECT("geometric_object");
