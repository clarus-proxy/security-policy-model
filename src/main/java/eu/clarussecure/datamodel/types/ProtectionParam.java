...
public enum ProtectionParam{
	...
	@SerializedName("k")
	KVALUE(ProtectionName.KANONIMITY, "k"),
	@SerializedName("t")
	TCLOSENESSVALUE(ProtectionName.TCLOSENESS, "t"),
	@SerializedName("radius")
	RADIUSVALUE(ProtectionName.COARSENING, "radius"),
	@SerializedName("clouds")
	CLOUDSNUMBER(ProtectionName.CLOUDS, "clouds");
